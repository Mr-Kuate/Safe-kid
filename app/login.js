    ...
    <TouchableWithoutFeedback
      ...
      <SafeAreaView className='flex-1 bg-white'>
        <View className='flex-1'>
          ...
          <View className='mt-[200px] flex-1'>
            <Text style={{ fontFamily: 'PlatypiLight' }} className='font-bold text-center text-6xl'> Hello <HelloWave/></Text>
            ...
            <View className='flex-row mt-[60px] justify-center space-x-1'>
              ...
              <Pressable><Text className='font text-base underline -mt-1'>Créez-en </Text></Pressable>
              </Link>
            </View>
          </View>
        </View>
