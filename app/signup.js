      ...
      <SafeAreaView className='flex-1'>
        <View className='flex-1'>
          ...
          <View className='flex-1 mt-[200px]'>
            <Text style={{ fontFamily: 'PlatypiLight' }} className='text-3xl text-center'> Créez votre compte <HelloWave/></Text>
            ...
            <View className='flex-row mt-[60px] justify-center space-x-1'>
              ...
              <Pressable>
                <Text className='font text-base underline -mt-1'> Connectez-vous </Text>
              </Pressable>
                </Link>
            </View>
          </View>
